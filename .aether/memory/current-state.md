...
- TASK-096 related tests 122 pass; tsc/lint/build 0. Full suite not re-run this close.
...
- Destination universe polish: Idle FPS not re-measured; Watch Now still uses cyan plate-edge (interaction language, not the old crossing ring).
